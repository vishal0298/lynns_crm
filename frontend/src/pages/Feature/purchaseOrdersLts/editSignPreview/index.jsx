            ...
            <div className="inv-content">
              <div className="invoice-header">
                ...
                <div className="inv-header-right">
                  ...
                  <div className="inv-details">
                    ...
                    <div className="inv-date">
                      Purchase Order No: <span>{rowData?.purchaseId}</span>
                    </div>
                  </div>
                </div>
              </div>
              <div className="invoice-address">
                <div className="invoice-to">
                  ...
                  <div className="inv-to-address">
                    {rowData?.vendorId?.vendor_name}
                    
                    <br />
                    {rowData?.vendorId?.vendor_email} <br />
                    {rowData?.vendorId?.vendor_phone}
                  </div>
                </div>
                <div className="invoice-to">
                  <span>Pay To:</span>
              ...
              <div className="bank-details">
                ...
                <div className="company-sign">
                  ...
                  <img src={rowData?.selectedSign} alt="signature-img" />
                </div>
              </div>
...
export default EditPreviewPurchase;
