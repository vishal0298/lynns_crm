...
import Data from "../assets/jsons/recurringPending";
...
const RecurringPending = () => {
  ...
  const columns = [
    ...
    },
    {
      ...
      sorter: (a, b) => a.StatusPending.length - b.StatusPending.length,
    },
    {
      title: "Action",
      dataIndex: "Action",
                  ...
                  <div className="col-lg-12">
                    <div className="invoices-tabs">
                      <ul>
                        ...
                        <li>
                          <Link to="/recurring-pending" className="active">
                            Pending
                          </Link>
                        </li>
                        <li>
...
export default RecurringPending;
