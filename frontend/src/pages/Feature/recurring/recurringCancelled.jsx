...
const RecurringCancelled = () => {
  ...
  const columns = [
    ...
    {
      title: "Status",
      dataIndex: "StatusCancel",
      render: (text) => <span className="badge bg-danger-light">{text}</span>,
      sorter: (a, b) => a.StatusCancel.length - b.StatusCancel.length,
    },
    {
      title: "Action",
      dataIndex: "Action",
                ...
                <div className="row align-items-center">
                  <div className="col-lg-12">
                    <div className="invoices-tabs">
                      <ul>
                        <li>
                          <Link to="/recurring-invoices">All Invoice</Link>
                        </li>
                        <li>
                        ...
                        <li>
                          <Link to="/recurring-cancelled" className="active">
                            Cancelled
                          </Link>
                        </li>
                      </ul>
...
export default RecurringCancelled;
