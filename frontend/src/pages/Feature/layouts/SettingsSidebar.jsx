          ...
          <ul>
            <li className="nav-item">
              <Link
                to="/settings"
                className={`${
                  "/settings" === pathName ? "active nav-link" : "nav-link"
                }`}
              >
            ...
            <li className="nav-item">
              <Link
                to="/tax-types"
                className={`${
                  "/tax-types" === pathName ? "active nav-link" : "nav-link"
                }`}
              >
            ...
            <li className="nav-item">
              <Link
                to="/notifications"
                className={`${
                  "/notifications" === pathName ? "active nav-link" : "nav-link"
                }`}
              >
